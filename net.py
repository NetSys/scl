...
def myNet():
    ...
    # Add Controllers
    sw_scl_1 = net.addController('c0', controller=RemoteController, ip=CONTROLLER_IP_1, port=6633)

    sw_scl_2 = net.addController('c1', controller=RemoteController, ip=CONTROLLER_IP_2, port=6634)
